...
/**
 * This class implements a FuncList
 * @param <T>
 */
public class FuncList<T> implements IFuncList<T> {
    ...
    /**
     * Create a FuncList from arguments
    ...
    /**
     * Compare a FuncList to another FuncList
     * @param other FuncList to compare to this one
    ...
    /**
     *
     * @param elem the element of type T to add to the front of the list
     ...
     * @param todo Function to run on each element
